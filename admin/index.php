                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card info-card revenue-card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">
                                    Faturamento Total
                                    <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="Faturamento total até o dia de hoje! Esse valor não contém o valor de parcelas de projetos dos próximos dias e meses, apenas até o dia atual. Se tiver uma parcela atrasada até o dia atual, o valor será somado mesmo assim ao faturamento">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card info-card revenue-card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">
                                    Despesas Totais
                                    <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="A soma do valor de todas as despesas pagas e pendentes até o dia de hoje!">
                                        <a class="text-decoration-none" href="#">
                                            <span class="material-symbols-outlined" style="font-size: 16px;">
                                                info
                                            </span>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card info-card revenue-card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">
                                    Lucro Total
                                    <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="O valor do lucro total é o faturamento total menos o valor das despesas totais">
                                        <a class="text-decoration-none" href="#">
                                            <span class="material-symbols-outlined" style="font-size: 16px;">
                                                info
                                            </span>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card info-card revenue-card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">
                                    Faturamento no Mês
                                    <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="Valor total do faturamento de 01 deste mês até o dia de hoje (<?= date('d/m') ?>)! Esse valor inclui parcelas de projetos que já foram pagas ou serão pagas nesse periódo do dia 01 até hoje.">
                                        <a class="text-decoration-none" href="#">
                                            <span class="material-symbols-outlined" style="font-size: 16px;">
                                                info
                                            </span>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card info-card revenue-card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">
                                    Despesas no Mês
                                    <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="A soma do valor de todas as despesas pagas e pendentes do dia 01 deste mês até hoje (<?= date('d/m') ?>)!">
                                        <a class="text-decoration-none" href="#">
                                            <span class="material-symbols-outlined" style="font-size: 16px;">
                                                info
                                            </span>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card info-card revenue-card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">
                                    Lucro no Mês
                                    <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="O valor do lucro no mês é o faturamento do mês menos o valor das despesas no mês, do dia 01 até hoje (<?= date('d/m') ?>)!">
                                        <a class="text-decoration-none" href="#">
                                            <span class="material-symbols-outlined" style="font-size: 16px;">
                                                info
                                            </span>
