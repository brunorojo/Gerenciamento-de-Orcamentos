                    ...
                    <table class="table table-borderless">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="../scripts.php?deletarcliente=<?php echo $dados["id"]; ?>" onclick="if(!confirm('Deseja remover este cliente?')) event.preventDefault()"><span class="material-symbols-outlined text-danger">delete</span></a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
