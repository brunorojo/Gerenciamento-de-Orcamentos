            ...
            <div class="modal-body">
                <form action="../scripts.php" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="valordesenvolvedor" id="dois" class="form-control"
                            id="recipient-name" require>
                    </div>

                    <div class="mb-3">
                        <label for="observacao" class="col-form-label">Mensagem: <span class=" opacity-50"
                                style="font-size: 11px">(Opcional)</span></label>
                        <input type="text" name="observacao" id="dois" class="form-control" id="observacao"
                            maxlength="500">
                    </div>
